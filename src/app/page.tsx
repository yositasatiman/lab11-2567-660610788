...
export default function RegisterForm() {
  ...
  const btnAgree = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const computeTotalPayment = () => {
    ...
    if(buyBottle && buyShoes && buyCap) total = total - ((total*20)/100);
  ...
  return (
    ...
    <span className="text-success d-block">(20% Discount Applied)</span>
  )}
      </div>

      {/* Terms and conditions */}
      <div>
        <input className="me-2" type="checkbox" onChange={btnAgree}/>
